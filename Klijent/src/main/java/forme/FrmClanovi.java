...
public class FrmClanovi extends javax.swing.JFrame {
    ...
    public FrmClanovi(FrmGlavna aThis) {
        initComponents();
        setLocationRelativeTo(null);
        this.glavna = aThis;
        srediTabelu();
    ...
    private void initComponents() {
        ...
        setTitle("Pretraga članova plivačkog saveza");
        ...
        jButton4.setText("Izbriši člana");
        ...
        jButton5.setText("Pregled promena");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnDodajClana, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnDodajClana, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPretraga, javax.swing.GroupLayout.DEFAULT_SIZE, 458, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (index != -1) {
            Clan clan = (Clan) mtc.getClanovi().get(index);
            Paket trenutniPaket = (Paket) mtc.vratiPaket(mtc.vratiPaketId(clan));
            FrmDodajClana fdc = new FrmDodajClana(this, clan, trenutniPaket);
            fdc.setVisible(true);
            this.setVisible(false);

        } else {
            JOptionPane.showMessageDialog(this, "Izaberite člana kog želite da izmenite!");
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (index != -1) {
            try {
                Clan clan = (Clan) mtc.getClanovi().get(index);
                int odluka = JOptionPane.showConfirmDialog(this, "Da li ste sigurni da želite da obrišete člana " + clan.toString() + "?", "", JOptionPane.WARNING_MESSAGE);
                if (odluka == 0) {
                    Clan obrisan = Kontroler.getInstance().obrisiClana(clan);
                    JOptionPane.showMessageDialog(this, "Uspešno ste obrisali člana " + obrisan.toString() + ".", "Obaveštenje", JOptionPane.INFORMATION_MESSAGE);
                    srediTabelu();
                }
            } catch (Exception ex) {
            ...
            JOptionPane.showMessageDialog(this, "Izaberite člana kog želite da izbrišete!");
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (index != -1) {
            try {
                ...
                List<AbstractObject> sviPaketi = mtc.getPaketi();
                List<AbstractObject> sviRanijiPodaci = Kontroler.getInstance().ucitajPromenePaketa();
                
                List<AbstractObject> ranijiPaketi = new ArrayList<>();
                for (AbstractObject AbstractObject : sviRanijiPodaci) {
                    PromenaPaketa pp = (PromenaPaketa) AbstractObject;
                    if (pp.getClan().equals(clan)) {
                        ranijiPaketi.add(pp);
                    }
                }
                FrmPromenaPaketa fic = new FrmPromenaPaketa(this, clan, ranijiPaketi, sviPaketi);
                fic.setVisible(true);
                this.setVisible(false);
            } catch (Exception ex) {
            ...
            JOptionPane.showMessageDialog(this, "Izaberite člana!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmClanovi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmClanovi().setVisible(true);
            }
        });
    }
